...
- [Как проверить монетку на "честность".](https://en.wikipedia.org/wiki/Checking_whether_a_coin_is_fair)
- $\frac{k}{n}$ не сработает, но формула сработает после совсем незначительных доработок.

[Решение](240.Монетки/Монетки.ipynb)
# 243. Рекомендательна система SVD
